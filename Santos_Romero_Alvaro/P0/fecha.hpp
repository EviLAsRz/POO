...
class Fecha{
    public:
        //Constantes
        static const int AnnoMinimo{1902};                  //si no son estaticos, da problemas con el operador de asignacion (lo borra por defecto)
        static const int AnnoMaximo{2037};

        //Constructores
        explicit Fecha(int d = 0,int m = 0,int a = 0);      //constructor fecha predeteminado, de 1, 2, y de 3 parametros enteros
